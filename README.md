> **Note:** this repo is a fork of [klinecharts](https://github.com/klinecharts/KLineChart), renamed, converted to typescript and bug fixes applied due to the original project being unmaintained.
