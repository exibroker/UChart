...
function config() {
    const ucharts = fs.readFileSync(
        path.join(path.dirname(process.cwd()), 'dist', 'umd', 'ucharts.min.js'),
        { encoding: 'utf-8' }
    )
    return defineConfig({
        vite: {
        ...
        themeConfig: {
            ...
            socialLinks: [
                ...
                // { icon: 'twitter', link: 'https://twitter.com/ucharts' }
            ],
            footer: {
                message: 'Released under the <a href="https://github.com/ucharts/KLineChart/blob/main/LICENSE">Apache License V2</a>.',
