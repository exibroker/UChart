...
export default defineConfig({
    ...
    themeConfig: {
        nav: [
            ...
            { text: 'Pro', link: 'https://pro.ucharts.com/en-US' },
            { text: 'Preview', link: 'https://preview.ucharts.com/#en-US' },
            { text: 'Customize', link: '/en-US/customize' },
            { text: 'Sponsor', link: '/en-US/sponsor' },
            {
                text: `${version}`,
                items: [
                    { text: '9.x Docs', link: 'https://v9.ucharts.com/en-US' },
                    { text: '8.x Docs', link: 'https://v8.ucharts.com' }
                ]
            }
        ],
        sidebar: {
        ...
        editLink: {
            pattern: 'https://github.com/ucharts/KLineChart/edit/main/docs/:path',
