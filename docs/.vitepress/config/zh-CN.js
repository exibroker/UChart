...
export default defineConfig({
    ...
    themeConfig: {
        nav: [
            ...
            { text: 'Pro', link: 'https://pro.ucharts.com' },
            { text: '预览', link: 'https://preview.ucharts.com' },
            { text: '定制', link: '/customize' },
            { text: '赞助', link: '/sponsor' },
            {
                text: `${version}`,
                items: [
                    { text: '9.x 文档', link: 'https://v9.ucharts.com' },
                    { text: '8.x 文档', link: 'https://v8.ucharts.com/zh-CN' }
                ]
            }
        ],
        sidebar: {
